...
class AdjointReversibleHeun(base_solver.BaseSDESolver):
    ...
    def __init__(self, sde, **kwargs):
        ...
        if self.forward_sde.noise_type == NOISE_TYPES.diagonal:
            ...
            # tensor1 [B,C,S] / tensor2 [B,D] => tensor1 [B,C,S,1] / tensor2 [B,1,D]
            self._adjoint_of_prod = lambda tensor1, tensor2: tensor1.unsqueeze(-1) * tensor2.unsqueeze(-2).unsqueeze(-2)
            # original : tensor1 [B,C] / tensor2 [B,D] => tensor1 [B,C,1] / tensor2 [B,1,D]
